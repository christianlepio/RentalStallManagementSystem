                ...
                <?php
                    if(isset($_GET['error'])){
                        if($_GET['error'] == "emptyinput"){
                            ...
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <small><strong> <i class="fa-solid fa-circle-exclamation"></i>&nbsp; Incorrect ID no.</strong></small>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>';
                ...
                <form action="includes/login.inc.php" method="post" class="row g-1 sform">
                    <div class="row g-3 justify-content-center">
                        <div class="input-group col-md-11">
                            ...
                            <input type="text" name="usname1" class="form-control" placeholder="ID no..." aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="input-group col-md-11">
                            ...
                            <input type="password" name="pword1" class="form-control" placeholder="Password..." aria-label="Username" aria-describedby="basic-addon1">    
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="col-md-11">
                            <center>
                                <button type="submit" name="login-tenant-submit" class="btn btn-primary btlogin">Log In as Tenant</button>
                            </center>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6">
                            <center><br><a href="login.php"><p>Login as Admin/Staff?</p></a></center>
                        </div>
                    </div>
                    <hr>
                </form>
